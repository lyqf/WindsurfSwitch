        ...
        switch (osType) {
            case 'windows':
                ...
                paths.push(
                    ...
                    path.join(localAppData, 'Programs', 'Windsurf - Next', 'resources', 'app', 'extensions', 'windsurf', 'dist', 'extension.js'),
                    path.join(localAppData, 'Programs', 'Windsurf Next', 'resources', 'app', 'extensions', 'windsurf', 'dist', 'extension.js'),
                    // 基于 appRoot 的路径
                    ...
                    path.join(programFiles, 'Windsurf - Next', 'resources', 'app', 'extensions', 'windsurf', 'dist', 'extension.js'),
                    // Portable 版本路径
